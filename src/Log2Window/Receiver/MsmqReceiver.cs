...
namespace Log2Window.Receiver
{
    ...
    public class MsmqReceiver : BaseReceiver
    {
        ...
        private string _queueName = @".\private$\log4net";

        [Category("Configuration")]
        [DisplayName("Queue Name")]
        [DefaultValue(@".\private$\log4net")]
        [Description(@"Name of the queue to create.  I.e. .\private$\log4net")]
        ...
        public override string SampleClientConfig
        {
            get
            {
                return
                    ...
                    Environment.NewLine + Environment.NewLine +
                    "<appender name=\"MsmqAppender\" type=\"AlanThinker.MyLog4net.MsmqAppender, AlanThinker.MyLog4net\">" +
                    Environment.NewLine +
                    "\t<queueName value=\".\\private$\\log4net\" />" + Environment.NewLine +
