...
namespace Log2Window
{
    partial class AboutForm : Form
    {
        public AboutForm()
        {
            ...
            lines.Add("");
            lines.Add("This is an open source application maintained by AlanThinker(alanthinker@126.com).");
            lines.Add("The initial source code is copied from Log2console written by R¨¦my Baudet aka Statyk7(statyk7@gmail.com) http://log2console.codeplex.com/.");
            lines.Add("");
            lines.Add("Additional Contributors:");
            lines.Add(" - R¨¦my Baudet aka Statyk7(statyk7@gmail.com) log2console author.");
